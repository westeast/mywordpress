...
$(document).ready(function(){
	...
	$('input:text').css('background','#fff url(image/'+searchEngine+'-back.png) center right no-repeat');
	...
	for (j=0; j <= (num-1); j++) {		
		for(i=0;i<=11;i++){								
			...
			if(thumb==''){
				$('#thumb'+(j+1)+'-'+(i+1)).html('<img id="net" src="image/net-back.png" /><a href="'+url+'"><div class="title">'+title+'</div></a>');
			}
			else{
				$('#thumb'+(j+1)+'-'+(i+1)).html('<a href="'+url+'"><img src="image/'+thumb+'" /></a>');
			}
		};
	};
	...
	$('#google1').click(function() {
		...
		$('#engines1').fadeToggle('fast','circEaseOut');
		$('#wrapper1 input:text').css('background','#fff url(image/google-back.png) center right no-repeat');
	...
	$('#bing1').click(function() {
		...
		$('#engines1').fadeToggle('fast','circEaseOut');
		$('#wrapper1 input:text').css('background','#fff url(image/bing-back.png) center right no-repeat');
		$('#wrapper1 input:hidden').detach();
		$('#wrapper1 input:first').attr('name','q');
		$('#wrapper1 input:text').focus();
	});
	...
	$('#yahoo1').click(function() {
		...
		$('#engines1').fadeToggle('fast','circEaseOut');
		$('#wrapper1 input:text').css('background','#fff url(image/yahoo-back.png) center right no-repeat');
		$('#wrapper1 input:hidden').detach();
		$('#wrapper1 input:first').attr('name','q');
		$('#wrapper1 input:text').focus();
	});
	...
	$('#wikipedia1').click(function() {
		...
		$('#engines1').fadeToggle('fast','circEaseOut');
		$('#wrapper1 input:text').css('background','#fff url(image/wikipedia-back.png) center right no-repeat');
		$('#wrapper1 input:text').focus();
	});
	...
	if(num>1){
		...
		$('#google2').click(function() {
			...
			$('#engines2').fadeToggle('fast','circEaseOut');
			$('#wrapper2 input:text').css('background','#fff url(image/google-back.png) center right no-repeat');
		...
		$('#bing2').click(function() {
			...
			$('#engines2').fadeToggle('fast','circEaseOut');
			$('#wrapper2 input:text').css('background','#fff url(image/bing-back.png) center right no-repeat');
			$('#wrapper2 input:hidden').detach();
			$('#wrapper2 input:first').attr('name','q');
			$('#wrapper2 input:text').focus();
		});
		...
		$('#yahoo2').click(function() {
			...
			$('#engines2').fadeToggle('fast','circEaseOut');
			$('#wrapper2 input:text').css('background','#fff url(image/yahoo-back.png) center right no-repeat');
			$('#wrapper2 input:hidden').detach();
			$('#wrapper2 input:first').attr('name','q');
			$('#wrapper2 input:text').focus();
		});
		...
		$('#wikipedia2').click(function() {
			...
			$('#engines2').fadeToggle('fast','circEaseOut');
			$('#wrapper2 input:text').css('background','#fff url(image/wikipedia-back.png) center right no-repeat');
			$('#wrapper2 input:text').focus();
		});
	};
	...
	if(num>2){
		...
		$('#google3').click(function() {
			...
			$('#engines3').fadeToggle('fast','circEaseOut');
			$('#wrapper3 input:text').css('background','#fff url(image/google-back.png) center right no-repeat');
		...
		$('#bing3').click(function() {
			...
			$('#engines3').fadeToggle('fast','circEaseOut');
			$('#wrapper3 input:text').css('background','#fff url(image/bing-back.png) center right no-repeat');
			$('#wrapper3 input:hidden').detach();
			$('#wrapper3 input:first').attr('name','q');
			$('#wrapper3 input:text').focus();
		});
		...
		$('#yahoo3').click(function() {
			...
			$('#engines3').fadeToggle('fast','circEaseOut');
			$('#wrapper3 input:text').css('background','#fff url(image/yahoo-back.png) center right no-repeat');
			$('#wrapper3 input:hidden').detach();
			$('#wrapper3 input:first').attr('name','q');
			$('#wrapper3 input:text').focus();
		});
		...
		$('#wikipedia3').click(function() {
			...
			$('#engines3').fadeToggle('fast','circEaseOut');
			$('#wrapper3 input:text').css('background','#fff url(image/wikipedia-back.png) center right no-repeat');
			$('#wrapper3 input:text').focus();
		});
	};
